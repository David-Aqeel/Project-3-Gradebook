...
urlpatterns = [
    ...
    path('cohorts/<int:cohort_id>/add_grade/<int:student_id>/', views.add_grade, name='add_grade'),
    ...
    # path('students/<int:student_id>/add_student_grades/', views.add_student_grades, name='add_student_grades'),
]
